...
const faqs = [
  {
    ...
    answer:
      "iOS development means creating apps that run on Apple devices like iPhones and iPads using Apple’s tools and guidelines.",
  },
  {
    question: "Why choose iOS app development for my business?",
    answer: [
      "iOS users often spend more on apps and services.",
      "iOS apps tend to have better performance and high security.",
      "Apple’s App Store gives access to a large, global user base.",
    ],
  },
  {
    question: "Can you design the app and help with app store submission?",
    answer:
      "Yes. We do app design, UI/UX, development, testing, and also help with the App Store submission process (following Apple guidelines, preparing assets, etc.).",
  },
  {
    question: "How do you ensure app quality and usability?",
    answer: [
      "Testing on different iOS devices and screen sizes",
      "Performance optimization",
      "UI/UX that follows Apple’s Human Interface Guidelines",
      "Security best practices and data protection",
    ],
  },
  {
    question: "Can the iOS app communicate with other systems or web services?",
    answer:
      "Yes. We can build apps that integrate with backend servers, APIs, databases, third-party services, or other platforms as you need.",
  },
];
...
const Ios = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Innovative iOS App Development | UI/UX Design Company | Infomagine
        </title>
        <meta
          name="description"
          content="From engaging designs to smooth migration, our iOS app development agency delivers innovative apps with trusted Apple app development services in India."
        />

        <link rel="canonical" href="https://infomagine.in/services/ios"></link>
        <meta
          property="og:title"
          content="Innovative iOS App Development | UI/UX Design Company | Infomagine"
        />
        <meta
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center px-10 md:px-20">
          <div data-aos="fade-right" className="text-white max-w-2xl space-y-5">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Your Trusted Partner for Apple App Development Services in India
            </h1>
            <p className="text-lg">
          ...
          {[
            {
              ...
              desc: "We build tailor-made iOS applications that align with your unique business requirements. From concept to execution, our expert developers use Swift, Objective-C, and the latest iOS SDKs to deliver high-performance, intuitive apps designed for maximum user engagement.",
              icon: design,
              aos: "fade-up",
            },
            {
              title: " iOS App Development & Deployment",
              desc: "Our end-to-end iOS development process covers everything—from UI/UX design and coding to App Store submission. We ensure your app meets Apple’s guidelines for approval and deliver a smooth launch experience with complete version control and testing.",
              icon: deployment,
              aos: "fade-down",
            },
            {
              title: "App Maintenance & Support",
              desc: "We offer ongoing support and regular maintenance to ensure your app stays updated, bug-free, and compatible with the latest iOS versions. Whether it's feature enhancements, performance optimization, or post-launch support, we've got you covered.",
              icon: development,
              aos: "zoom-in",
            },
            {
              title: "UI/UX Design for iOS",
              desc: "Our design team creates visually stunning and user-friendly interfaces that match Apple’s Human Interface Guidelines. We focus on delivering intuitive navigation and engaging user experiences that enhance user satisfaction and retention.",
              icon: testing,
              aos: "flip-left",
            },
            {
              title: "iOS App Migration & Upgrade",
              desc: "Planning to move your existing app to iOS or upgrade to the latest iOS version? We provide seamless migration services without compromising performance, data, or user experience—ensuring a smooth transition across platforms or versions.",
              icon: lunch,
              aos: "fade-right",
            },
            {
              title: "Enterprise iOS App Development",
              desc: "We build scalable, secure, and feature-rich iOS apps tailored for internal business operations or B2B needs. With integration into enterprise systems like CRM, ERP, and cloud services, our solutions help streamline workflows and improve productivity.",
              icon: market,
              aos: "fade-left",
            },
          ].map((item, index) => (
