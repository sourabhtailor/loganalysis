...
const faqs = [
  {
    ...
    answer:
      "IT consulting means giving expert advice about how your business can use technology well. This includes planning software, systems, networks, and strategies to improve operations and meet goals.",
  },
  {
    question: "Why do I need IT consulting services?",
    answer: [
      "To get professional help with tech decisions.",
      "To save time and money by avoiding wrong choices.",
      "To improve efficiency, security, and performance of your systems.",
      "To stay updated with new tech trends and best practices.",
    ],
  },
  {
    question: "What kinds of consulting do you offer?",
    answer:
      "Services may include: evaluating your current IT systems, planning upgrades, designing system architecture, choosing software/tools, cybersecurity advice, cloud strategy, business process improvement, etc.",
  },
  {
    question: "Can you work with businesses in different industries?",
    answer:
      "Yes. IT consulting is useful for many kinds of business—small, medium, large; in industry, services, e-commerce, etc. We adapt our advice to your business type, size, and environment.",
  },
  {
    question: "What happens after the consulting is done?",
    answer:
      "After delivering the advice/ plan, you can choose whether you want us to help with implementation. If you want, we can also offer ongoing support, monitoring, or periodic reviews to ensure things are working well.",
  },
];
...
const ItConsultingServices = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          IT Consultation | IT Services Company - Infomagine Softwares
        </title>
        <meta
          name="description"
          content="Infomagine Softwares, among the best IT services and consulting companies in India, offering tailored solutions to drive digital success."
        />

        <link
          rel="canonical"
          href="https://infomagine.in/services/it-consulting-services"
        ></link>
        <meta
          property="og:title"
          content="IT Consultation | IT Services Company - Infomagine Softwares"
        />
        <meta
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center px-10 md:px-20">
          <div data-aos="fade-right" className="text-white max-w-2xl space-y-5">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Leading IT Services & Consulting Company in India
            </h1>
            <p className="text-sm">
      ...
      {/* Intro Section */}
      <section className="flex flex-col md:flex-row px-20 pb-10 pt-20 bg-[#f9f9f9] gap-10">
        {/* Left Content */}
      ...
      <section className="flex flex-col md:flex-row p-20 bg-[#f9f9f9] gap-10">
        ...
        <div className="flex-1">
          ...
          <h2 className="mb-5">Our Strategic Approach to Your Success</h2>
      ...
      <section className="bg-gray-50 pb-16 pt-8 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="mb-18">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              market-leading realities. From the very first spark of an idea to
              a fully developed, revenue-generating product, we walk with you
              ...
              With our innovation-driven approach, your start-up gets the
              perfect blend of strategy, technology, and execution to scale
              faster and smarter.
              <br />
              After all, empowering your start-up to reach new heights is what
              we do best!
            </p>
          </div>
      ...
      <section className="py-16 px-6 md:px-20 bg-gray-50">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            At Infomagine, we transform your start-up vision into a
            high-performing digital reality. From deep market understanding to
            flawless execution, our expert team ensures your business gets the
            perfect blend of strategy, design, and technology to stand out in
            today’s competitive market. We focus on delivering scalable,
            intuitive, and impactful IT solutions that fuel growth, enhance user
            experience, and set the foundation for long-term success.
          </p>
        </div>
