...
const offerings = [
  ...
  },
  {
    ...
    icon: (
      <FaUsersCog className="text-[#FF3C00] text-5xl border border-[#FF3C00] p-2 rounded-full mr-2" />
    ),
  },
  {
    ...
    icon: (
      <FaChartBar className="text-[#FF3C00] text-5xl border border-[#FF3C00] p-2 rounded-full mr-2" />
    ),
  },
  {
...
const faqs = [
  {
    ...
    answer:
      "React Native is a framework that lets developers build mobile apps that work on both iOS and Android using mostly the same code.",
  },
  {
    question: "Why should I choose React Native?",
    answer: [
      "Faster development, because much of the code is shared between platforms.",
      "Lower cost than building two separate native apps.",
      "Consistent look & feel across iOS and Android.",
      "Easier maintenance, since there’s one codebase for many updates and bug fixes.",
    ],
  },
  {
    question: "Will my React Native app perform as well as a native app?",
    answer:
      " Usually yes for most use-cases. React Native can deliver good performance. For very heavy graphics or specialized native features, we might recommend native modules or mixed (hybrid) approaches.",
  },
  {
    question: "Can React Native apps access device features like camera, GPS, push notifications, etc.?",
    answer:
      "Yes. React Native can integrate with many device-specific features. If needed, we can write native modules to cover custom or advanced hardware features not supported out-of-the-box.",
  },
  {
    question: "Can React Native apps work offline?",
    answer:
      "Yes. We can build offline features, such as storing data locally on the device and syncing with the server once internet is available.",
  },
];
...
const ReactNative = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          React Native | React JS | API & Backend Development Company
        </title>
        <meta
          name="description"
          content="We deliver Custom React Native App Development services with API & Backend Development service in India, React JS expertise, and reliable testing solutions."
        />

        <link
          rel="canonical"
          href="https://infomagine.in/services/react-native"
        ></link>
        <meta
          property="og:title"
          content="React Native | React JS | API & Backend Development Company"
        />
        <meta
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center px-10 md:px-20">
          <div data-aos="fade-right" className="text-white max-w-2xl space-y-5">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Custom React Native App Development Service to Scale Your Ideas{" "}
            </h1>
            <p className="text-lg">
              Establish a Strong Digital Presence with Fast, Flexible &
