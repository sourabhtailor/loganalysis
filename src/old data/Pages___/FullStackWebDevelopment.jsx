        ...
        <div className="absolute inset-0 bg-black/50 flex items-center px-10 md:px-20">
          <div data-aos="fade-right" className="text-white max-w-2xl space-y-5">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Robust, Scalable & Intuitive Solutions for Your Business
            </h1>
            <p className="text-lg">
              At Infomagine, we specialize in delivering full stack web
              development services that combine powerful back-end systems with
              seamless front-end experiences. Whether you need a custom web
              application, an e-commerce platform, or a dynamic business portal,
              our expert developers ensure your solution is fast, secure, and
              future-ready.
            </p>

            <p>
              We leverage the latest technologies, frameworks, and coding best
              practices to build applications that can handle high traffic,
              adapt to evolving business needs, and offer an exceptional user
              experience.
            </p>
            <Link
              to="/contact-us"
  ...
  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
    ...
    <div className="p-6 border border-gray-300 rounded-2xl shadow hover:shadow-lg transition">
      ...
      <p className="text-gray-700">
        Build dynamic, secure, and high-performing web solutions using robust
        PHP frameworks like Laravel, CodeIgniter, and Symfony.
      </p>
    </div>
    ...
    <div className="p-6 border border-gray-300 rounded-2xl shadow hover:shadow-lg transition">
      <img
        ...
        className="w-16 h-16 mb-4"
      />
      <h3 className="text-xl font-semibold mb-2">JavaScript Development</h3>
      <p className="text-gray-700">
        From front-end interactivity to backend logic, we harness JavaScript’s
        full potential using React, Vue, Node.js, and more.
      </p>
    </div>
    ...
    <div className="p-6 border border-gray-300 rounded-2xl shadow hover:shadow-lg transition">
      ...
      <p className="text-gray-700">
        Deliver enterprise-grade applications with the scalability and security
    ...
    <div className="p-6 border border-gray-300  rounded-2xl shadow hover:shadow-lg transition">
      <img
        src="https://image.flaticon.com/icons/svg/2415/2415292.svg"
    ...
    <div className="p-6 border border-gray-300 rounded-2xl shadow hover:shadow-lg transition">
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/d/d4/Api.svg"
        alt="API Development"
        className="w-16 h-16 mb-4"
      />
      ...
      <section className="flex flex-col md:flex-row p-20 bg-[#f9f9f9] gap-10">
        ...
        <div className="flex-1">
          ...
          <p className="max-w-2xl text-gray-700 text-sm leading-relaxed mb-6">
            At Infomagine, our Full Stack Web Developers bring unmatched expertise in both front-end and back-end development. From crafting intuitive user interfaces to managing robust databases and resolving complex bugs, we provide end-to-end solutions that ensure seamless functionality and exceptional performance. With precision, innovation, and dedication, we aim to set new benchmarks in the industry.

          </p>

          <h2 className="font-bold mb-5 text-[#ff3c00]">Why Partner with Our Full Stack Experts?</h2>

          {/* Added Points */}
         <ul className="list-disc pl-5 space-y-3 text-gray-700">
  <li>
    <strong>Extensive Experience –</strong> Work with seasoned professionals
    with 9+ years of expertise in full stack web development.
  </li>
  <li>
    <strong>Mastery of Modern Technologies –</strong> Highly skilled in the
    latest tools, frameworks, and programming languages.
  </li>
  <li>
    <strong>Strict Confidentiality –</strong> We respect your privacy with
    binding non-disclosure agreements.
  </li>
  <li>
    <strong>Dedicated Project Management –</strong> 100% commitment from our
    project managers for smooth execution.
  </li>
  <li>
    <strong>Comprehensive Guidance –</strong> From concept creation to final
        ...
        >
         ...
         Our Development Process
          ...
          <p className="mt-3 text-gray-600 md:text-lg">
           At Infomagine, we follow a strategic, transparent, and result-driven development process that ensures every project turns into a digital success story. From brainstorming innovative ideas to deploying the final product, we keep our approach agile, collaborative, and focused on your goals.
          ...
          {steps.map((step, idx) => (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className={`grid size-12 place-items-center rounded-xl bg-gradient-to-br ${step.color}`}>
