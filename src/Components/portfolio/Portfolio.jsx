...
import khtbg from "../../assets/khtbg.png";
import khtmobile from "../../assets/khtmobile.png";
import madstackimg1 from "../../assets/madstackimg1-1.png";
import mobile from "../../assets/invitehivecasestudymobile.png";
import background from "../../assets/invitehivecasestudybanner.png";
import madstackbg from "../../assets/madstackbg.png";
...
const portfolioItems = [
  ...
  // },
  { id: 3, title: "Fundnest", image: fundnest, href: "https://fundnest.in/" },
  {
    id: 4,
    title: "Lift creative",
    image: lifecreative,
  ...
  { id: 9, title: "Krrida", image: krridahome, href: "https://krrida.com/" },
  { id: 10, title: "Zedbox", image: Zedbox, href: "https://zedbox.co.in/" },
  {
    id: 11,
    title: "JM Exports",
    image: Jmexports,
  ...
  return (
    <Layout>
      ...
      <div className="mb-20 flex gap-20 flex-col">
        ...
        <div className="flex gap-60 relative justify-between items-center">
          <div>
            <img width={1600} src={background} alt="" />
          </div>

          <div className="flex flex-col items-start gap-5">
            <div>
              <h1 className="text-6xl text-[#FF4100] font-bold">InviteHive</h1>
              <p className="text-2xl italic">Share & Celebrate</p>
            </div>
            ...
            <a href="/casestudy/invitehive">
              {" "}
              <button className="bg-black py-3 flex justify-center items-center gap-3 cursor-pointer  px-6 rounded-sm text-white">
                View Case Study <img src={arrow} alt="" />{" "}
              </button>
            </a>
          </div>

          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <img className="animate-float" width={250} src={mobile} alt="" />
          </div>
        </div>
        ...
        <div className="flex gap-60 relative justify-between items-center">
          <div className="flex flex-col pl-20  gap-5">
            <div>
              <h1 className="text-5xl text-[#FF4100] font-bold">
                Kanha Home Tutions
              </h1>
              <p className="text-2xl italic">Expert Tutors, Better Grades</p>
            </div>
            ...
            <a href="/casestudy/kanha-home-tutions">
              {" "}
              <button className="bg-black py-3 flex justify-center items-center gap-3 cursor-pointer  px-6 rounded-sm text-white">
                View Case Study <img src={arrow} alt="" />{" "}
              </button>
          ...
          <div>
            <img width={3500} src={khtbg} alt="" />
          </div>

          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <img className="animate-float" width={250} src={khtmobile} alt="" />
          </div>
        </div>

        {/* madstack */}

        <div className="flex gap-90 relative justify-between items-center">
          <div>
            <img width={3500} src={madstackbg} alt="" />
          </div>
          ...
          <div className="flex flex-col items-start gap-5">
            ...
            <span className="w-[70%]">
              MadStack Innovation partnered with a leading technology enterprise
              to streamline its operations, enhance efficiency, and implement
              scalable solutions. With a focus on innovation and digital
              transformation, MadStack delivered tailored IT services that
              addressed key operational challenges while driving measurable
              business growthe
            </span>

            <a href="/casestudy/madstack-inovation">
              {" "}
              <button className="bg-black py-3 flex justify-center items-center gap-3 cursor-pointer  px-6 rounded-sm text-white">
                View Case Study <img src={arrow} alt="" />{" "}
              </button>
